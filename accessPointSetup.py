...
dnsmasq_config.writelines(["interface=wlan0\n", "dhcp-range={}.2,{}.20,255.255.255.0,24h\n".format(static_ip, static_ip), "address=/#/{}.1".format(static_ip)])
...
hostapd_config.writelines("\n".join([line0, line1, line2, line3, line4, line5, line6, line7, line8, line9, line10, line11, line12, line13]))
