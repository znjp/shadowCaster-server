import sys
import web, hashlib, os, random, string, time, pickle
...
def init_users():
	...
	db["znjp"] = {"password":"brak4pres", "solved":False, "flag":hashlib.sha1("znjp" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["alpha"] = {"password":"ZnTkHA", "solved":False, "flag":hashlib.sha1("alpha" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["bravo"] = {"password":"dTdRtLY", "solved":False, "flag":hashlib.sha1("bravo" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["charlie"] = {"password":"dZUokZ", "solved":False, "flag":hashlib.sha1("charlie" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["delta"] = {"password":"HewLwZ", "solved":False, "flag":hashlib.sha1("delta" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["echo"] = {"password":"pRhzpa", "solved":False, "flag":hashlib.sha1("echo" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["foxtrot"] = {"password":"djUTAm", "solved":False, "flag":hashlib.sha1("foxtrot" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["golf"] = {"password":"DMTBQa", "solved":False, "flag":hashlib.sha1("golf" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["hotel"] = {"password":"xokRDs", "solved":False, "flag":hashlib.sha1("hotel" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["india"] = {"password":"PZEUXn", "solved":False, "flag":hashlib.sha1("india" + "sc" + str(SHADOWCASTER)).hexdigest()}
	db["juliet"] = {"password":"gKZFQr", "solved":False, "flag":hashlib.sha1("juliet" + "sc" + str(SHADOWCASTER)).hexdigest()}
	sync_db()
	return
